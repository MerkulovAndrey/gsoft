...
CREATE TABLE gsoft.managers (
    ...
    `surname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'фамилия менджера',
    `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'имя менеджера',
    `email` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'email менеджера',
    `phone` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'телефон менеджера',
    PRIMARY KEY (`id`)
)
ENGINE=InnoDB
